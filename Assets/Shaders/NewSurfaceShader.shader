...
Shader "Custom/NewSurfaceShader"
{
    Properties
    {
        ...
        _Opacity ("Opacity", Range(0,1)) = 1.0 // Add opacity property with a default of fully opaque
    }
    SubShader
    {
        Tags{ "RenderType" = "Transparent" } // Change render type to Transparent
        Blend SrcAlpha OneMinusSrcAlpha // Add blend mode for transparency
        ZWrite Off // Typically, you should disable ZWrite for transparency
        LOD 200
		...
		Pass
        {
            ...
            sampler2D _MainTex;
            float _Opacity; // Declare opacity to use in the shader
